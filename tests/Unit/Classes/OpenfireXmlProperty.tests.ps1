...
InModuleScope $ProjectName {
    ...
    Describe OpenfireXmlProperty {
        ...
        Context ('{0}Type creation' -f $global:encString) {
            It ('{0}Should be type named OpenfireXmlProperty' -f $global:encString) {
                $instance = [OpenfireXmlProperty]::new()
                $instance.GetType().Name | Should -Be 'OpenfireXmlProperty'
            }
        }
    ...
    @($false, $true) | ForEach-Object {
        ...
        Describe ("{0}OpenfireXmlProperty\CRUD functions" -f $global:encString) -Tag 'CRUD' {
            BeforeEach {
        ...
        Describe ("{0}OpenfireXmlProperty\Get Method" -f $global:encString) -Tag 'Get' {
            BeforeEach {
        ...
        Describe ("{0}OpenfireXmlProperty\Test Method" -f $global:encString) -Tag 'Test' {
            BeforeEach {
                $script:instanceDesiredState = [OpenfireXmlProperty]  @{
                    OpenfireHome = "$($mockOpenfireHome)"
                    PropertyName = 'purple.people'
            ...
            Context ('{0}OpenfireXmlProperty\Test\When the system is in the desired state' -f $global:encString) {

                Context ('{0}OpenfireXmlProperty\Test\When the configuration is absent' -f $global:encString) {
                ...
                Context ('{0}OpenfireXmlProperty\Test\When the configuration is present' -f $global:encString) {
                    It ('{0}Should return $true' -f $global:encString) {
            ...
            Context ('{0}OpenfireXmlProperty\Test\When the system is not in the desired state' -f $global:encString) {
                BeforeEach {
                    # return an empty value to signify a missing value
                    $script:instanceDesiredState.mockActualValue = $null
                }

                Context ('{0}OpenfireXmlProperty\Test\When the configuration should be absent' -f $global:encString) {
        ...
        Describe ("{0}OpenfireXmlProperty\Set Method" -f $global:encString) -Tag 'Set' {
            BeforeEach {
                $script:instanceDesiredState = [OpenfireXmlProperty]  @{
                    OpenfireHome = "$($mockOpenfireHome)"
                    PropertyName = 'purple.people'
